...
# ========= SETUP PATHS =========
model_path = Path(r"/accident_detection/model/accident_detection_model.keras")
video_path = Path(r"C:/Users/cmpor/PycharmProjects/EdgeAI_Benchmark_Project/accident_detection/data/input/video2.mp4")
...
while True:
    ...
    prediction = model.predict(img, verbose=0)[0][0]  # Output: single scalar
